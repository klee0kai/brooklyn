...
ComKlee0kaiExampleModelNullableTypePojo brooklyn::ComKlee0kaiExampleEngineSimpleJniEngine::copyNullableType(
        const ComKlee0kaiExampleModelNullableTypePojo &simple) {
    return simple;
}
...
ComKlee0kaiExampleEngineSimpleJniEngine::copyArrayModel(const ComKlee0kaiExampleModelArraysModel &arrays) {
    return arrays;
}

ComKlee0kaiExampleModelBoxedArraysModel ComKlee0kaiExampleEngineSimpleJniEngine::copyBoxedArrayModel(
        const ComKlee0kaiExampleModelBoxedArraysModel &arrays) {
    return arrays;
}

void ComKlee0kaiExampleEngineSimpleJniEngine::holdSimpleMirror(
        const ComKlee0kaiExampleMirrorsSimpleJniMirror &simple) {
